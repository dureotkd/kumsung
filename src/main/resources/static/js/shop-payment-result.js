(async()=>{
  ...
  try{
    ...
    paymentResultIcon.textContent="✓";paymentResultIcon.classList.add("ok");paymentResultTitle.textContent="테스트 결제가 완료되었습니다.";paymentResultMessage.textContent="실제 금액은 차감되지 않았습니다.";
