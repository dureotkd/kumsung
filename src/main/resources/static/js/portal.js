  ...
  try{
    ...
    $("quoteDetail").innerHTML=`
      ...
      <div class="quote-detail-body">
        ...
        <section class="detail-section"><div class="detail-section-title"><h3>추가자료 업로드</h3></div><form id="suppForm" class="upload-box"><label>PDF·이미지·CAD·엑셀 자료<input type="file" name="files" multiple required accept=".pdf,.jpg,.jpeg,.png,.dwg,.dxf,.xls,.xlsx,.zip"></label><button class="primary">추가자료 업로드</button></form></section>
